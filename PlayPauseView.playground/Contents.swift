...
let playPauseView = PlayPauseView(frame: CGRect(x: 0, y: 0, width: 60, height: 60))
playPauseView.clipsToBounds = true
playPauseView.animate()


playPauseView.center = view.center
